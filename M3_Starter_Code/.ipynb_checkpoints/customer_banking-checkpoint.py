...
from savings_account import creat_savings_account
...
def main():
    ...
    savings_maturity=float(input("How many months to determine the interest? : "))
    ...
    cd_maturity=float(input("How many months to determine the interest? : "))
